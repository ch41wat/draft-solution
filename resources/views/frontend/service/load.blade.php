<div class="row" id="load" style="position: relative;">
    ...
    <div class="col-md-12" style="background-image: url({{ asset('storage/uploads/' . $item->path . '/picture/' . $item->picture_name) }}); background-size: 100% 100%; background-repeat: no-repeat; min-height: 390px; width: 100%; margin-bottom: 10px;">
        @php $layer = 1 @endphp
        @for ($i = 1; $i <= 3; $i++)
            <div class="row">
            @for ($j = 1; $j <= 6; $j++)
